...
class ApisdClient:
    ...
    def __init__(self, token: str, base_url: str = "https://api.apisdom.com"):
        ...
        Args:
            token: Tu token JWT de apisdom.com/dashboard
    ...
    def analizar_sentimiento(self, texto: str) -> dict:
        ...
        Raises:
            ...
            TokenInvalidoError: Token JWT inválido o expirado
        """
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("🔒 Token inválido. Obtén uno nuevo en el Dashboard")
